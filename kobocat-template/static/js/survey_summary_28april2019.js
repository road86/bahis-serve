...
console.log(isOwner+'--'+dataObj+'Can_View::'+Can_View+'Can_submit::'+Can_submit+'Can_edit::'+Can_edit);
    ...
    var spTableRowData = $('<td class="tg-yw4l">'+title + '<br><strong>'+form_perm+'</strong></td><td  style="padding:8px 8px 8px 0px; ">'+study+'</td></td><td  style="padding:8px 8px 8px 0px; ">'+form_shortname+ '</td><td>'+details+' '+ projectSettings +' '   + roleSettings +' ' + edit+' ' + schedule + '</td>');
